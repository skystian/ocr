 ...
 * @method array passport($files, $options = []) 护照识别
 * @method array household($files, $options = []) 户口页识别
 * @method array seal($files, $options = []) 印章识别
 * @method array taxiTicket($files, $options = []) 出租车发票识别
 * @method array vin($files, $options = []) 出租车发票识别
 */
class OCRManager
{
    /**
    ...
    protected $oldRequestBody = false;
...
//    const OCR_PASSPORT          = 'http://ocrhz.market.alicloudapi.com/rest/160601/ocr/ocr_passport.json';
//    const OCR_HOUSEHOLD         = 'https://household.market.alicloudapi.com';
//    const OCR_SEAL              = 'http://tysbgpu.market.alicloudapi.com/api/predict/ocr_general';
//    const OCR_TAXI_TICKET       = 'http://tysbgpu.market.alicloudapi.com/api/predict/ocr_general';
//    const OCR_VIN               = 'http://tysbgpu.market.alicloudapi.com/api/predict/ocr_general';
